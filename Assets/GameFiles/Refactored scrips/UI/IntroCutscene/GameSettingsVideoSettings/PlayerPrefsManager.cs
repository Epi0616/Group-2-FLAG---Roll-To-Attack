...
public class PlayerPrefsManager : MonoBehaviour
{
    ...
    private static void SetUpDefaultSettings() //not sure of a better way to do this atm :/ (probably a per instance setup?? so i dont set somthing up that doesnt get used???)
    {
    ...
    public static void SetString(PlayerValues setting, string input)
    {
        PlayerPrefs.SetString(setting.ToBinaryString(), input);
    }
    public static void SetInt(PlayerValues setting, int input)
    {
        PlayerPrefs.SetInt(setting.ToBinaryString(), input);
    }
    public static void SetFloat(PlayerValues setting, float input)
    {
        PlayerPrefs.SetFloat(setting.ToBinaryString(), input);
    }
    public static void SetBool(PlayerValues setting, bool input)
    {
    ...
    public static string GetString(PlayerValues setting)
    {
        return PlayerPrefs.GetString(setting.ToBinaryString());
    }
    public static int GetInt(PlayerValues setting)
    {
        return PlayerPrefs.GetInt(setting.ToBinaryString());
    }

    public static float GetFloat(PlayerValues setting)
    {
        return PlayerPrefs.GetFloat(setting.ToBinaryString());
    }

    public static bool GetBool(PlayerValues setting, out bool outBool)
    {
    ...
    public static bool CheckForSetKey(PlayerValues setting)
    {
